...
public class Timer extends AppCompatActivity {
    ...
    private void updateWatchInterface() {
        if (mTimerRunning) {
            ...
            if (mTimeLeftInMillis < 1000) mButtonStartPause.setVisibility(View.INVISIBLE);
            else mButtonStartPause.setVisibility(View.VISIBLE);
            if (mTimeLeftInMillis < mStartTimeInMillis) mButtonReset.setVisibility(View.VISIBLE);
            else mButtonReset.setVisibility(View.INVISIBLE);
        }
    }
